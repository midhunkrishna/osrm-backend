...
BOOST_AUTO_TEST_CASE(check_conditional_restrictions_values)
{
    ...
    auto restrictions = ParseConditionalRestrictions("120 @ 06:00-20:00; 100 @ (22:00-06:00 AND length>5)");

    BOOST_REQUIRE(restrictions.size() == 2);
    BOOST_CHECK(restrictions.at(0).value == "120");
    BOOST_CHECK(restrictions.at(0).condition == "06:00-20:00");
    BOOST_CHECK(restrictions.at(1).value == "100");
    BOOST_CHECK(restrictions.at(1).condition == "22:00-06:00 AND length>5");
}
